...
graph TD
    ...
    subgraph Quality Control
        Tests[tests/test_analyzer.py] -->|136 Pytest cases| Lib
...
- **`tests/test_analyzer.py`**: A comprehensive test suite with 136 test cases verifying affix stripping, phonological contractions, edge-case regressions, and negative bounds.
